...
- The cleanup function is a special function that we can add to our `useEffect` hook. It tells React what to do when our component is done. In our example, we would use the cleanup function to remove the event listener we added earlier.
